package io.github.dpr;


import io.github.dpr.crypto.CryptoResult;
import io.github.dpr.crypto.NativeInterface;
    ...
    public static void main(String[] args) throws Exception {
        {
            ...
            CryptoResult result =
                    NativeInterface.secp256k1Verify(
                            keyPair.publicKey, message, Signature.signature);
        ...
        }
        {
            ...
            CryptoResult signature =
                    NativeInterface.sm2SignFast(keyPair.privateKey, keyPair.publicKey, message);
        ...
        //            String message =
        // "847adcf9b24cf0041ddff02ffe324e30b1271c5170086f8ee799dd1123dacb2e";
        ...
        //            CryptoResult resultTrue =  NativeInterface.sm2verify(keyPair.publicKey,
        // message, Signature.signature);
        //            System.out.println("result = " + resultTrue.result);
        //
        //            String messageErr =
        // "47adcf9b24cf0041ddff02ffe324e30b1271c5170086f8ee799dd1123dacb2e";
        //            CryptoResult result =  NativeInterface.sm2verify(keyPair.publicKey,
        // messageErr, Signature.signature);
